...
===================================================
Some experiments with self-organizing systems and emergent behavior. Current methods include a Brownian motion algorithm, a Vicsek active matter model, and a branching-and-annihilating random walk. Also a test bed for RunTime, a framework for building real-time interactive simulations in Jupyter notebooks.
